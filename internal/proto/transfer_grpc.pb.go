...
const (
	TransferService_MakeTransfer_FullMethodName = "/transfer.TransferService/MakeTransfer"
)
...
func (c *transferServiceClient) MakeTransfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransferService_MakeTransfer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransferServiceServer) MakeTransfer(context.Context, *TransferRequest) (*TransferResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MakeTransfer not implemented")
}
...
func _TransferService_MakeTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_MakeTransfer_FullMethodName,
	}
...
var TransferService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/proto/transfer.proto",
}
